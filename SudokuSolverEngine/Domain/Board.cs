namespace SudokuSolverEngine.Domain
{
    public class Board
    {
        ...
        public Board(byte[,] p_Values)
        {
            ...
            for (var y = 0; y < p_Values.GetLength(0); y++)
            for (var x = 0; x < p_Values.GetLength(1); x++)
        ...
        public bool SameData(byte[,] p_Data)
        {
            ...
            for (var y = 0; y <= p_Data.GetLength(0) - 1; y++)
            for (var x = 0; x <= p_Data.GetLength(1) - 1; x++)
